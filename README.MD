...
**SmartStay Pvt. Ltd.** – Rental Property Management & Analytics
...
- Property View count with unique ip address for popular property
...
#### 3. Setup Backend (Server) -  open a new PowerShell window
```powershell
